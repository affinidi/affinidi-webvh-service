...
use crate::did_hosting_tasks::{
    ...
    TASK_DID_REQUEST_1_0, TASK_SERVER_HEALTH_PING_1_0, TASK_SERVER_HEALTH_PONG_1_0,
    TASK_SERVER_REGISTER_1_0, TASK_SERVER_REGISTER_ACK_1_0, TASK_SERVER_STATS_ACK_1_0,
    TASK_SERVER_STATS_SYNC_1_0, TASK_WEBVH_SYNC_DELETE_1_0, TASK_WEBVH_SYNC_DELETE_ACK_1_0,
    TASK_WEBVH_SYNC_UPDATE_1_0, TASK_WEBVH_SYNC_UPDATE_ACK_1_0, TASK_WEBVH_WITNESS_CONFIRM_1_0,
...
use crate::didcomm_types::{
    ...
    MSG_DID_REGISTER, MSG_DID_REGISTER_CONFIRM, MSG_DID_REQUEST, MSG_HEALTH_PING, MSG_HEALTH_PONG,
    MSG_INFO, MSG_INFO_REQUEST, MSG_LIST, MSG_LIST_REQUEST, MSG_PROBLEM_REPORT,
...
fn alias_pairs() -> [(&'static str, &'static str); 29] {
    [
        // Auth
...
mod tests {
    ...
    use crate::didcomm_types::{
        ...
        MSG_PROBLEM_REPORT, MSG_SERVER_REGISTER, MSG_SERVER_REGISTER_ACK, MSG_STATS_ACK,
        MSG_STATS_SYNC, MSG_SYNC_DELETE, MSG_SYNC_DELETE_ACK, MSG_SYNC_UPDATE, MSG_SYNC_UPDATE_ACK,
