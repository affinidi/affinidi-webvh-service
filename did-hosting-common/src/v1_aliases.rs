...
use crate::did_hosting_tasks::{
    ...
    TASK_DID_REQUEST_1_0, TASK_DOMAIN_ASSIGN_1_0, TASK_DOMAIN_UNASSIGN_1_0,
...
use crate::didcomm_types::{
    ...
    MSG_DOMAIN_UNASSIGN, MSG_HEALTH_PING, MSG_HEALTH_PONG, MSG_INFO, MSG_INFO_REQUEST, MSG_LIST,
    MSG_LIST_REQUEST, MSG_PROBLEM_REPORT, MSG_SERVER_REGISTER, MSG_SERVER_REGISTER_ACK,
    MSG_STATS_ACK, MSG_STATS_SYNC, MSG_SYNC_DELETE, MSG_SYNC_DELETE_ACK, MSG_SYNC_UPDATE,
    MSG_SYNC_UPDATE_ACK, MSG_WITNESS_CONFIRM, MSG_WITNESS_PUBLISH,
};
...
fn alias_pairs() -> [(&'static str, &'static str); 31] {
    [
        // Auth
...
mod tests {
    ...
    use crate::didcomm_types::{
        ...
        MSG_DID_CHANGE_OWNER_CONFIRM, MSG_DID_CONFIRM, MSG_DID_OFFER, MSG_DID_PUBLISH,
        MSG_DID_REGISTER, MSG_DID_REGISTER_CONFIRM, MSG_DID_REQUEST, MSG_DOMAIN_ASSIGN,
        MSG_DOMAIN_UNASSIGN, MSG_HEALTH_PING, MSG_HEALTH_PONG, MSG_INFO, MSG_INFO_REQUEST,
        MSG_LIST, MSG_LIST_REQUEST, MSG_PROBLEM_REPORT, MSG_SERVER_REGISTER,
